...
//	pText			: Address of a string containing the item抯 text.
//	nImage			: Index of the item抯 image in the tree view control抯 image list.
//	nSelImage		: Index of the item抯 selected image in the tree view control抯 image list.
//	nState			: Specifies values for the item抯 states. SeeTree View Control Item States in the Platform SDK for a list of appropriate states.
...
//	hParent			: Handle of the inserted item抯 parent.
